...
$query = "INSERT INTO derived_gstr1_periodical_summary (`month`,`b2b_iv_by_total_value`,`b2c_liv_by_total_value`,`b2c_siv_by_total_value`,`Export_Iv`,`Total_TV`,`Total_Iv`)
SELECT 
