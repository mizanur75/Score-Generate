INSERT INTO `data_analysis`(`ref_id`,`b2b_iv`, `b2c_liv`,`b2c_siv`,`export_iv`,`sci_gst`,`tax_zero_outware`,`tax_nill_outware`,`tax_paid_in_credit`,`latest_fy_iv`, `pre_fy_iv`,`total_iv_flag`,`compare_tiv`,`compare_ttv`,`payment_null_0`,`late_fee_null_0`,`credit_transaction_amount`,`cheque_bounce_outward`,`cheque_bounce_inward`,`tech_cheque_bounce_inward`,`non_tech_cheque_bounce_inward`,`cash_withdrawal`)
